...
var FirestoreModule = (function () {
  ...
  var _classThis;
  var FirestoreModule = (_classThis = /** @class */ (function () {
    function FirestoreModule_1() {}
    return FirestoreModule_1;
  })());
  __setFunctionName(_classThis, 'FirestoreModule');
  (function () {
    var _metadata =
    ...
    FirestoreModule = _classThis = _classDescriptor.value;
    if (_metadata)
  ...
  return (FirestoreModule = _classThis);
})();
