...
var FirestoreService = (function () {
  ...
  var FirestoreService = (_classThis = /** @class */ (function () {
    ...
    FirestoreService_1.prototype.createReference = function (
      collection,
      conditions,
      limit,
      group,
    ...
    FirestoreService_1.prototype.createReferenceByID = function (
      collection,
      id,
    ) {
      var db = admin.firestore();
    ...
    FirestoreService_1.prototype.createCollectionReference = function (
      collection,
      doc,
    ) {
    ...
    FirestoreService_1.prototype.getDocumentsList = function (
      collection,
      conditions,
      limit,
    ) {
    ...
    FirestoreService_1.prototype.getCollectionGroupDocuments = function (
      collection_1,
    ) {
      return __awaiter(
        this,
        arguments,
        void 0,
        function (collection, conditions, limit) {
          var docs;
          if (conditions === void 0) {
            conditions = [];
          }
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!d.exists)
                throw new common_1.BadRequestException({
                  message: ''
                    .concat(id, ' document in ')
                    .concat(collection, ' not found'),
    ...
    FirestoreService_1.prototype.getDocumentByRef = function (ref_1) {
      return __awaiter(
        ...
        arguments,
        void 0,
        function (ref, errorOnNotExist) {
          var doc;
          if (errorOnNotExist === void 0) {
    ...
    FirestoreService_1.prototype.setDocumentById = function (
      collection,
      id,
      payload,
    ) {
    ...
    FirestoreService_1.prototype.updateDocumentByID = function (
      collection,
      id,
      payload,
    ) {
    ...
    FirestoreService_1.prototype.deleteSubCollection = function (path) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          return [
            2 /*return*/,
            this.deleteDocumentsInCollection(subCollectionRef),
          ];
        });
      });
    };
    FirestoreService_1.prototype.deleteDocumentsInCollection = function (
      collectionRef,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        var query;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                (0, firestore_1.deleteQueryBatch)(query, resolve),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
    ...
    FirestoreService_1.prototype.paginateCollection = function (
      collection_1,
      limit_1,
      offset_1,
      sortBy_1,
      ...
      return __awaiter(
        ...
        arguments,
        void 0,
        function (collection, limit, offset, sortBy, sortOrder) {
          var db, ref, docs;
          if (sortOrder === void 0) {
            sortOrder = 'asc';
          }
